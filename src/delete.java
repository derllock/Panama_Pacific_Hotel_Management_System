...
public class delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("(By Phone No.)");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 290, -1, -1));
        ...
        jLabel8.setText("DELETE RECORDS");
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 280, -1, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String c=jTextField3.getText();
                ...
                String query="DELETE from hotel where  bookno= "+jTextField1.getText()+"  OR  phoneno='"+c+"';";
                Statement stmt= con.createStatement();
                 stmt.executeUpdate(query);
                 JOptionPane.showMessageDialog(null,"Booking No "+a+", Deleted Successfully");
                stmt.close();
                con.close();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            String query = "SELECT * FROM hotel WHERE phoneno ='"+jTextField3.getText()+"'";
            ResultSet rs = stmt.executeQuery(query);
